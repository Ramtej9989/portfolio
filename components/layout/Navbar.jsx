      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <motion.div
              className="fixed top-16 left-0 right-0 bottom-0 z-50 bg-[#1E0B34] flex flex-col p-4"
              initial={{ x: '-100%' }}
              animate={{ x: 0 }}
              exit={{ x: '-100%' }}
              ...
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col">
                {navLinks.map((link) => (
                  <button
                    ...
                    } flex items-center gap-3 px-4 py-4 rounded-md text-base font-medium border-b border-secondary/10 text-left`}
